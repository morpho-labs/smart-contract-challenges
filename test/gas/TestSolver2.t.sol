...
import {GuessTheNumber2, ISolver2} from "src/gas-optis/g06-solver2/Common.sol";
import {Solver2 as Reference} from "src/gas-optis/g06-solver2/Reference.sol";
import {Solver2 as Optimized} from "src/gas-optis/g06-solver2/Optimized.sol";
...
contract TestSolver2 is Test, Utils {
    ...
    function testGasSolver2() public {
        ...
        printGasResult(refGas, 10000, 4162, optiGas);
    }
}
